...
- **NEW badge** — โชว์เฉพาะตอนสัญญาณ BUY/SELL **สลับจริง** (เทียบกับ B/S ครั้งล่าสุด โดยข้าม HOLD ที่คั่นกลาง เช่น S,B,H,H,B → B ตัวท้ายไม่ใช่ของใหม่)
- **Sparkline** — กราฟเส้นเล็ก 14 วันข้างชื่อแต่ละสินทรัพย์
- **คลิกแถวเพื่อดูรายละเอียด** — EMA12/26, RSI(14), ประวัติสัญญาณรายวัน 14 วัน
